...
const FurnitureAndHomeGarden = () => {
    return (
        <section>
            <h2 className={styles.ps_heading}>What's new in  <span className={styles.higlight_title}>Furniture, Home and Garden</span></h2>
...
export default FurnitureAndHomeGarden
