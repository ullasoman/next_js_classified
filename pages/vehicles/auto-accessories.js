...
export default function accessories() {
    ...
    const { data, isLoading, isError } = fetcher('search/accessories')
...
function Ads({ data }) {
    ...
    return (
        <ListingCard key={id} id={id} identity={identity} directory={'auto-accessories'} breadcrumb={breadcrumb} title={title} title_for_vue_url={title_for_vue_url} images={images} currency={currency} price={price} year={year} kilometer={kilometer} color={color} location={location} />
    )
}